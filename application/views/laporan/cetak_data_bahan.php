			...
			<div class="invoice-box">
				...
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					<tr class="heading">
						...
						<td style="width:10%!important;text-align:right">HARGA BELI</td>
						<td style="width:10%!important;text-align:right">HARGA JUAL</td>
						<td style="width:10%!important;text-align:center">STATUS STOK</td>
					</tr>
					...
					<?php
						...
						<tr class="item">
							...
							<td class="border" align='right'><?=rp($row->harga_jual); ?></td>
